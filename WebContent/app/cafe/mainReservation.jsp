		...
		<div class="searchContainer">
			<div class="searchBox">
				...
				<form id="search" action="" method="post">
					<input type="text" ,
              autocomplete="off"
						id="searchInput" placeholder="카페이름을 입력하세요" value="" />
										...
										<div class="checkboxArea">
											<div class="checkboxStyle">
												...
												<ul id="" class="locationArea">
													...
													<li class="Area"><label> <input
															type="checkbox" name="area"> <span>관악구</span>
													</label></li>
													<li class="Area"><label> <input
															type="checkbox" name="area"> <span>광진구</span>
													</label></li>
													<li class="Area"><label> <input
															type="checkbox" name="area"> <span>구로구</span>
													</label></li>
													<li class="Area"><label> <input
															type="checkbox" name="area"> <span>금천구</span>
													</label></li>
													<li class="Area"><label> <input
															type="checkbox" name="area"> <span>노원구</span>
													</label></li>

												</ul>
												<ul id="ex" class="locationArea none">
													<li class="Area"><label> <input
															type="checkbox" name="area"> <span>경기전체</span>
													</label></li>
												</ul>

												<ul class="locationArea none">
													<li class="Area"><label> <input
															type="checkbox" name="area"> <span>인천 전체</span>
													</label></li>
												</ul>
												<ul class="locationArea none">
													<li class="Area"><label> <input
															type="checkbox" name="area"> <span>부산 전체</span>
													</label></li>
												</ul>
												<ul class="locationArea none">
													<li class="Area"><label> <input
															type="checkbox" name="area"> <span>대구 전체</span>
													</label></li>
												</ul>
												<ul class="locationArea none">
													<li class="Area"><label> <input
															type="checkbox" name="area"> <span>대전 전체</span>
													</label></li>
												</ul>
												<ul class="locationArea none">
													<li class="Area"><label> <input
															type="checkbox" name="area"> <span>울산 전체</span>
													</label></li>
												</ul>
												<ul class="locationArea none">
													<li class="Area"><label> <input
															type="checkbox" name="area"> <span>세종 전체</span>
													</label></li>
												</ul>

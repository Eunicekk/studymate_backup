$(document).ready(function () {
  ...
  $("#summernote-cafe-add").summernote({
    width: 973.2,
    height: 500, // 에디터 높이
    minHeight: null, // 최소 높이
    maxHeight: null, // 최대 높이
    focus: false, // 에디터 로딩후 포커스를 맞출지 여부
    lang: "ko-KR", // 한글 설정
    placeholder: "스터디 카페에 대한 소개글을 작성해 주세요.", //placeholder 설정
  });
  ...
  $("#summernote-faq").summernote({
    ...
    focus: false, // 에디터 로딩후 포커스를 맞출지 여부
    lang: "ko-KR", // 한글 설정
    placeholder: "자주 묻는 질문에 대한 내용을 작성해 주세요.", //placeholder 설정
  });
});
        ...
        external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.fn.extend(
          {
            ...
            summernote: function summernote() {
              ...
              $(".note-view").remove();
              $(".note-table").remove();
              $(".note-insert").children().last().remove();

...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/assets/css/groupRead.css" />
<link rel="stylesheet"
...
<body>
	...
	<div>
		...
		<main class="boardContent-wrapper">
			...
			<section class="boardContent-postHeader">
				...
				<div class="currentColor">
					<button type="button" class="prev-to-list"
						data-studyGroupNumber="${group.studyGroupNumber}">
				...
				<div class="boardContent-userAndDate">
					...
					<div class="boardContent-editButtons">
						...
						<button type="button" class="boardContent-delete"
							data-studyGroupNumber="${group.studyGroupNumber}">삭제</button>
						<%--   </c:if> --%>
					</div>
				...
				<!-- 스터디그룹 정보 -->
				<ul class="studyInfo">
					<li class="studyInfoList"><span class="studyTitle">모집
							분야</span> <span class="studyFeild"> <c:out
								value="${group.getStudyGroupField()}" />
					</span></li>
					<li class="studyInfoList"><span class="studyTitle">진행
							방식</span> <span class="studyFeild"> <c:out
								value="${group.getStudyGroupOnline()}" />
					</span></li>
					<li class="studyInfoList"><span class="studyTitle">모집
							인원</span> <span class="studyFeild"> <c:out
								value="${group.getStudyGroupCapacity()}" />
					</span></li>
					<li class="studyInfoList"><span class="studyTitle">모집
							마감일</span> <span class="studyFeild"> <c:out
								value="${group.getStudyGroupEndDate()}" />
					</span></li>
					<li class="studyInfoList"><span class="studyTitle">연락
							방법</span> <a href="#" class="studyEmail">
							<div class="">
					...
					<li class="studyInfoList"><span class="studyTitle">예상
							기간</span> <span class="studyFeild"> <c:out
								value="${group.getStudyGroupDuration()}" />
					</span></li>
				</ul>
			</section>
				...
				<div class="boardContent-postComment">
					<div class="commentInput-wrap">
						...
						<h1 class="commentInput-count">
							<span class="cnt"> <c:out
									value="${group.getStudyGroupCommentCount()}" />
							</span> 개의 댓글이 있습니다
						</h1>
						<textarea class="commentInput-commentText" id="commentContent"
							placeholder="댓글을 입력하세요"></textarea>

						<div class="commentInput-buttonWrapper">
							<button class="commentInput-buttonComplete" name="register"
								data-memberNumber="${group.memberNumber}">댓글 등록</button>
						</div>
					</div>
			...
			<input class="memberNumber" type="hidden"

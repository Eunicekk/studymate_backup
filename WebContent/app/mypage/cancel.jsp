...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/assets/css/cancel.css" />
</head>
<body>
	<div class="main">
		<!-- 헤더 영역 -->
					...
					<li class="reserve-item">
						<div class="info-box">
							...
							<div>
								...
								<div class="info-box-reserve-detail-box">
									<p class="info-box-reserve-detail">
										<img src="https://shareit.kr/image/myPage/ico-cancel.svg" />
										취소 완료
									</p>
									<div class="info-box-detail">예약 상세</div>
								</div>
							</div>
						</div>
						<section class="sub-info-box">
							<div class="sub-info-text-box">
								<div>
									<p>상품명</p>
									<div>
										<span class="sub-info-status-info">취소/환불</span>
										<p>1인 동립형 일반</p>
									</div>
								</div>
								<div>
								...
								<div>
									<p>사용 시간</p>
									<p>
										2023-03-31 (금) 13:00 시작 <br /> 2023-03-31 (금) 15:00 종료
									</p>
								</div>
								<div>
									<p>인원</p>
	...
	<script src="${pageContext.request.contextPath}/assets/js/cancel.js"></script>
</body>
</html>
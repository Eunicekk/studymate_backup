...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/interestGroup.css" />
    <script
  ...
  <body>
    ...
    <script src="${pageContext.request.contextPath}/assets/js/interestGroup.js"></script>
  </body>
</html>

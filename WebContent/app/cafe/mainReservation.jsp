...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/main_reservation.css" />
  </head>
  <body>
    <header></header>
    <main id="main">
      ...
      <div class="searchContainer">
          ...
          <ul class="filterContainer">
            ...
            <li class="filterBtn location">
              <div class="filterlist">
                <button class="filter">
                  <span class="fontColor">지역</span>
                  <span class="filterImg">
                    <img src="${pageContext.request.contextPath}/assets/img/arrow-down-87-new.f91c9db5.svg" />
                  </span>
                </button>
              </div>
              <!-- 모달창 -->
                      ...
                      <div class="checkboxArea">
                        <div class="checkboxStyle">
                          ...
                          <ul id="" class="locationArea" >
                            <li class="Area">
                              <label>
                                <input id="all" type="checkbox" name="area" value="서울전체">
                                <span>서울전체</span>
                              </label>
                            </li>
                            <li class="Area">
                              <label >
                                <input type="checkbox" name="area" value="강남구">
                                <span>강남구</span>
                              </label>
                            </li>
                            <li class="Area">
                              <label >
                                <input type="checkbox" name="area" value="강동구">
                                <span>강동구</span>
                              </label>
                            </li>
                            <li class="Area">
                              <label >
                                <input type="checkbox" name="area" value="강북구">
                                <span>강북구</span>
                              </label>
                            </li>
                            <li class="Area">
                              <label >
                                <input type="checkbox" name="area" value="강서구">
                                <span>강서구</span>
                              </label>
                            </li>
                            <li class="Area">
                  ...
                  <form id=reset_test_form>
                    <div class="wrapper">
                      ...
                      <div class="price-input">
                        <div class="field">
                          <span>Min</span>
                          <input type="number" class="input-min" value="12500" >
                        </div>
                        <div class="separator">-</div>
                        <div class="field">
                          <input type="number" class="input-max" value="37500" />
                          <span>Max</span>
                        </div>
                      </div>
                      ...
                      <div class="range-input">  
                        ...
                        <input type="text" class="min" hidden>
                        <input type="text" class="max" hidden>
                      </div>
        ...
        <div class="mainSpace">
          ...
          <ul class="spaceList">
            <li>
              <a href="${pageContext.request.contextPath}/app/cafe/reservation.jsp" class="cafeOpen">
                <div class="spaceImg">
                  <img class="imgInfo" src="${pageContext.request.contextPath}/assets/img/be0a11cf-0d08-4cd9-8719-88937088cf4b.jpg" alt="뉴욕감성">
                ...
                <div class="spaceItem">
                  <div class="studyCafeName">
                    ...
                    <div class="readContLike">
                      <!-- 조회순 -->
                      <span class="CntLikeStyle">
                        <span class="box-sizing">
                          <img src="${pageContext.request.contextPath}/assets/img/icn-chat-filled-lightgray.d59bfd98.svg" alt="">
                        </span>
                        156</span>
                        <!-- like수 -->
                      <span class="CntLikeStyle">
            ...
            <li>
              <a href="">
                ...
                <div class="spaceItem">
                  ...
                  <!-- 카페 위치 -->
                  <p class="studyCafeLocation">서울시 동대문구 사가정로 148 sk스포트상가 토모집</p>

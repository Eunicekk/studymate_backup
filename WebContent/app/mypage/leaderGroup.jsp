...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/leaderGroup.css" />
    <script
  ...
  <body>
              ...
              <a href="" class="study-item-open">
                <li>
                  ...
                  <div class="study-schedule">
                    <p>마감일</p>
                    <p>${myLeaderGroup.getStudyGroupStartDate() }</p>
                  </div>
                  <h1 class="study-title">
                    ${myLeaderGroup.getStudyGroupTitle() }
                  </h1>
                  ...
                  <section class="study-item-info">
                    <div class="study-user-info">
                      ...
                      <div class="leader">${myLeaderGroup.getMemberNumber() }</div>
                    </div>
    ...
    <script src="${pageContext.request.contextPath}/assets/js/leaderGroup.js"></script>
  </body>
</html>

...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/ModifyingProfile.css" />
 </head>
  <body>
    <div class="main">
    ...
    <script src="${pageContext.request.contextPath}/assets/js/ModifyingProfile.js"></script>
  </body>
</html>
